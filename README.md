...
It inludes slides `workshop_slides.pdf` and an example text data set `multilingual_data.csv` which is a subset of the [REMINDER media corpus](https://doi.org/10.11587/IEGQ1B).
